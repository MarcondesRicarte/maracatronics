...
public class RobotController {
     ...
     public void goToPosition(CameraReader cameraReader, Field field, Robot robot, Ball ball){
     ...
     public RobotController(Robot robot, Robot obstacles[], Ball ball, double dt, double m, double fMax, double diam) {
         this.diam = diam;
         this.fMax = fMax;
         this.m = m;
         this.dt = dt;
